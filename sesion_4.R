...
plot(s641_social, layout=social_layout, edge.arrow.size=.1)
...
plot(s641_task, layout=task_layout, edge.arrow.size=.1)
...
edge.arrow.size = 0.1, layout=layout.fruchterman.reingold,main='Classroom S641 Social Talk')
