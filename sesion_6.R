...
m182_task_matrix <- rbind(as.matrix(m182_task_matrix_row_to_col), m182_task_matrix_col_to_row)
m182_task_matrix
...
m182_social_matrix <- rbind(as.matrix(m182_social_matrix_row_to_col), 
                            m182_social_matrix_col_to_row)
m182_social_matrix
...
library(NetCluster)
clustered_observed_cors <-clustConfigurations(num_vertices,
                                              m182_task_social_hclust,
                                              m182_task_social_cors)
...
# Task valued
task_mean <- mean(m182_task_matrix_row_to_col %>% as.matrix)
task_mean

task_valued_blockmodel <- blockmodel(m182_task_matrix_row_to_col %>% as.matrix(), clusters)
...
task_binary_blockmodel <- blockmodel(m182_task_matrix_row_to_col_bin %>% as.matrix(), 
                                     clusters)
...
social_valued_blockmodel <- blockmodel(m182_social_matrix_row_to_col %>% as.matrix(), 
                                       clusters)
...
social_binary_blockmodel <- blockmodel(m182_social_matrix_row_to_col_bin %>% as.matrix(),
                                       clusters)
...
task_triads <- sna::triad.census(m182_task %>% get.adjacency() %>% as.matrix())
task_triads
